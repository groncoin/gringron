...
lazy_static! {
	pub static ref GRINGRON_BASIC_REALM: HeaderValue =
		HeaderValue::from_str("Basic realm=GrinGronAPI").unwrap();
	pub static ref GRINGRON_FOREIGN_BASIC_REALM: HeaderValue =
		HeaderValue::from_str("Basic realm=GrinGronForeignAPI").unwrap();
}
