# GrinGron's Security Process

GrinGron has a [code of conduct](CODE_OF_CONDUCT.md) and the handling of vulnerability disclosure is no exception. We are committed to conduct our security process in a professional and civil manner. Public shaming, under-reporting or misrepresentation of vulnerabilities will not be tolerated.
...
GrinGron is committed to working with researchers who submit security vulnerability
...
For all security related issues, GrinGron has 2 main points of contact:

* Daniel Lehnberg, daniel.lehnberg at protonmail.com [PGP key](https://github.com/groncoin/gringron-security/blob/master/keys/lehnberg.asc)
* John Woeltz, joltz at protonmail.com [PGP key](https://github.com/groncoin/gringron-security/blob/master/keys/j01tz.asc)
...
that has never affected GrinGron, our intention is to inform those projects of
security issues on a best effort basis.

In the case where we fix a security issue in GrinGron that also affects the
...
_GrinGron does not currently have any established bilateral disclosure agreements._

## Recognition and Bug Bounties

GrinGron's responsible disclosure standard includes some general language about
...
GrinGron is a **traditional open source project with limited to no direct funding**.
...
There is not currently a formal bug bounty program for GrinGron as it would require
a high level of resources and engagement to operate in good faith. More
[funding](https://gringron.com/fund) can help provide the necessary
resources to run one in the future for the GrinGron community.

## Deviations from the Standard

GrinGron is a technology that provides strong privacy with zero-knowledge
...
Additional security-related information about the GrinGron project including previous
audits, CVEs, canaries, signatures and PGP public keys can be found in the
[gringron-security](https://github.com/groncoin/gringron-security) repository.
