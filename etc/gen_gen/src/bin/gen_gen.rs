...
use gringron_miner_plugin as plugin;
use gringron_store as store;
use gringron_util::{self as util, ToHex};
use gringron_wallet as wallet;

use gringron_core::core::hash::Hashed;
use gringron_core::core::verifier_cache::LruVerifierCache;
use gringron_keychain::{BlindingFactor, ExtKeychain, Keychain};
...
fn main() {
...

	{
		...
		let tmp_chain = setup_chain(".gringron.tmp", core::pow::mine_genesis_block().unwrap());
