...
fn comments() -> HashMap<String, String> {
	...
	retval.insert(
		...
		"
# Generated Server Configuration File for GrinGron
#
# When running the gringron executable without specifying any command line
...
"
	...
	retval.insert(
		"db_root".to_string(),
		"
#the directory, relative to current, in which the gringron blockchain
#is stored
"
		.to_string(),
	);
...
#real mining should use the standalone gringron-miner
"
		.to_string(),
	);
...
#test_miner_wallet_url = \"http://127.0.0.1:5635\"
...
#seeds = [\"192.168.0.1:5634\",\"192.168.0.2:5634\"]

#hardcoded peer lists for allow/deny
#will *only* connect to peers in allow list
#peers_allow = [\"192.168.0.1:5634\", \"192.168.0.2:5634\"]
#will *never* connect to peers in deny list
#peers_deny = [\"192.168.0.3:5634\", \"192.168.0.4:5634\"]
#a list of preferred peers to connect to
#peers_preferred = [\"192.168.0.1:5634\",\"192.168.0.2:5634\"]
