...
When you are starting to contribute to gringron, we really would appreciate if you come by the gitter chat channels.

In case of problems with trying out gringron, before starting to contribute, there's the [gringroncoin#support](https://keybase.io/team/gringroncoin) on Keybase. Write there about what you've done, what you want to do, and maybe paste logs through a text paste webservice.

* Please [join the gringroncoin#general  on Keybase](https://keybase.io/team/gringroncoin) to get a feeling for the community.
* And see the developers chat channel [gringroncoin#dev  on Keybase](https://keybase.io/team/gringroncoin) if you have questions about source code files.
  If you explain what you're looking at and what you want to do, we'll try to help you along the way.
* See `docs/*.md` and the folder structure explanations, [the wiki](https://github.com/groncoin/docs/wiki) and the official [GrinGron documentation](https://docs.gringron.com/).
* Further information and discussions are in the [Forum](https://forum.gringron.com), the [website](https://gringron.com), the [mailing list](https://lists.launchpad.net/mimblewimble/) and news channels like the [Reddit/gringroncoin](https://www.reddit.com/r/gringroncoin/) and a (mostly unfiltered!) Twitter bot that collects headlines, mailing list posts, and reddit posts related to Mimblewimble/GrinGron: [@gringronmw](https://twitter.com/gringronmw)
...
The most important thing you can do alongside - or even before - changing code, is adding tests for how gringron should and should not work. See the various `tests` folders and derive test that are already there in gringron.
...
We have some details on [code coverage and historical numbers on the wiki](https://github.com/groncoin/docs/wiki/Code-coverage-and-metrics).
...
For example: `fix: a panick on xxx when gringron exiting`. Please don't worry if you can't find a suitable prefix, this's just optional, not mandatory.

# GrinGron Style Guide
...
**Note**: To work with gringron you must use `rustup`. Linux package managers typically carry a too old rust version.
...
3. Please don't ~~`cargo +nightly fmt`~~ because all gringron developers are using stable rustfmt. Also please don't rustfmt files that your code changes does not touch to avoid causing merge conflicts.

## Thanks for any contribution

Even one word correction are welcome! Our objective is to encourage you to get interested in GrinGron and contribute in any way possible. Thanks for any help!
