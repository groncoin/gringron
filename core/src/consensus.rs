...
/// A gringron is divisible to 10^9, following the SI prefixes
pub const GRINGRON_BASE: u64 = 1_000_000_000;
/// Milligringron, a thousand of a gringron
pub const MILLI_GRINGRON: u64 = GRINGRON_BASE / 1_000;
/// Microgringron, a thousand of a milligringron
pub const MICRO_GRINGRON: u64 = MILLI_GRINGRON / 1_000;
/// Nanogringron, smallest unit, takes a billion to make a gringron
pub const NANO_GRINGRON: u64 = 1;
...
/// The block subsidy amount, one gringron per second on average
pub const REWARD: u64 = BLOCK_TIME_SEC * GRINGRON_BASE;
