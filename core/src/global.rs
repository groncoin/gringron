...
use crate::consensus::{
	...
	DMA_WINDOW, GRINGRON_BASE, INITIAL_DIFFICULTY, KERNEL_WEIGHT, MAX_BLOCK_WEIGHT, OUTPUT_WEIGHT,
...
/// Default unit of fee per tx weight, making each output cost about a GrinGroncent
pub const DEFAULT_ACCEPT_FEE_BASE: u64 = GRINGRON_BASE / 100 / 20; // 500_000
...
/// Default to gringron-cent/20 if global config unset.
