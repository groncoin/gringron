...
// 	"mainnet.seed.gringron.lesceller.com", // q.lesceller@gmail.com
// 	"mainnet.seed.gringron.prokapi.com",   // hendi@prokapi.com
// 	"gringronseed.revcore.net",            // yeastplume@gmail.com
// 	"mainnet-seed.gringronnode.live",      // info@gringronnode.live
// 	"mainnet.gringron.punksec.de",         // gringron@punksec.de
// 	"gringronnode.30-r.com",               // trinitron@30-r.com
// ];
pub const MAINNET_DNS_SEEDS: &[&str] = &[
	"69.57.163.207", 
];
...
pub const TESTNET_DNS_SEEDS: &[&str] = &[
	"floonet.seed.gringron.lesceller.com", // q.lesceller@gmail.com
	"floonet.seed.gringron.prokapi.com",   // hendi@prokapi.com
	"gringrontestseed.revcore.net",        // yeastplume@gmail.com
	"testnet.gringron.punksec.de",         // gringron@punksec.de
	"testnet.gringronnode.30-r.com",       // trinitron@30-r.com
];
