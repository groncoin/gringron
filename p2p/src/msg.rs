...
/// GrinGron's user agent with current version
pub const USER_AGENT: &str = concat!("MW/GrinGron ", env!("CARGO_PKG_VERSION"));

/// Magic numbers expected in the header of every message
const OTHER_MAGIC: [u8; 2] = [72, 42];
const TESTNET_MAGIC: [u8; 2] = [82, 58];
const MAINNET_MAGIC: [u8; 2] = [96, 60];
