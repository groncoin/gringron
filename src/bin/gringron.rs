...
//! Main for building the binary of a GrinGron peer-to-peer node.
...
pub fn info_strings() -> (String, String) {
	(
		format!(
			"This is GrinGron version {}{}, built for {} by {}.",
...
fn real_main() -> i32 {
	let yml = load_yaml!("gringron.yml");
