...
This document describes some of the basic functionality and requirements of gringron's transaction pool.
...
Given the focus of gringron (and mimblewimble) on reduced resource consumption, the memory pool should be an optional but recommended component for non-mining nodes.
