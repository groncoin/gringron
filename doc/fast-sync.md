...
In GrinGron, we call "sync" the process of synchronizing a new node or a node that
...
by other blockchains, but this is problematic for GrinGron as it typically does not
download full blocks.

In short, a fast-sync in GrinGron does the following:
