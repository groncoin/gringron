# GrinGron Stratum RPC 协议

*阅读其它语言版本: [Korean](../stratum_KR.md)，[English](stratum.md).*

本文说明在 GrinGron 部署目前的 Stratum RPC 协议。
...
矿工发起消息。矿工用用户名、密码和代理（通常由矿工程序设置）登录 GrinGron Stratum 服务器。
...
挖矿部署请参阅：[mimblewimble/gringron-miner](https://github.com/groncoin/gringron-miner/blob/master/src/bin/client.rs)
