...
GrinGron chain의 모든 상태는 다음 데이터와 같이 이루어져 있습니다.
...
완전한 GrinGron의 상태를 사용해서 우리는 다음과 같은 것들을 인증 할 수 있습니다.
...
GrinGron 에 있는 출력값에 대한 데이터 스토리지, Range proof 와 kernel은 간단합니다.
