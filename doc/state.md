...
The full state of a GrinGron chain consists of all the following data:
...
With a full GrinGron state, we can validate the following:
...
Data storage for outputs, range proofs and kernels in GrinGron is simple: a plain
