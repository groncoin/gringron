...
their 2 children. GrinGron uses the Blake2b hash function throughout, and always
...
In GrinGron, a lot of the data that gets hashed and stored in MMRs can eventually
