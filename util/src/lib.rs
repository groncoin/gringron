...
//! patterns that are frequent within the gringron codebase.
...
/// Global stopped/paused state shared across various subcomponents of GrinGron.
///
/// "Stopped" allows a clean shutdown of the GrinGron server.
