...
use gringron_store::Error::NotFoundErr;
...
impl Chain {
	...
	/// Specific tmp dir.
	/// Normally it's ~/.gringron/main/tmp for mainnet
	/// or ~/.gringron/test/tmp for Testnet
	...
	pub fn txhashset_write(
		...
		// Write txhashset to sandbox (in the GrinGron specific tmp dir)
