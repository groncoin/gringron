...
fn test_header_perf() {
	...
	let src_root_dir = format!("/Users/yeastplume/Projects/gringron_project/server/chain_data");
	let dest_root_dir = format!("/Users/yeastplume/Projects/gringron_project/server/.chain_data_copy");
