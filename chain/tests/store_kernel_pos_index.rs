...
use crate::gringron_store::Error;
...
fn test_store_kernel_idx_clear() -> Result<(), Error> {
	setup_test();
	let chain_dir = ".gringron_idx_clear";
	clean_output_dir(chain_dir);
