...
fn test_pibd_copy_sample() {
	...
	// Note there is now a 'test' in gringron_wallet_controller/build_chain
...
fn test_pibd_copy_real() {
	...
	let src_root_dir = format!("/home/yeastplume/Projects/gringron-project/servers/floo-1/chain_data");
	let dest_template_dir = format!(
		"/home/yeastplume/Projects/gringron-project/servers/floo-pibd-1/chain_data_headers_only"
	);
	let dest_root_dir =
		format!("/home/yeastplume/Projects/gringron-project/servers/floo-pibd-1/chain_data_test_copy");
